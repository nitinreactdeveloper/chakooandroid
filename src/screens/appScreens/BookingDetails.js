        ...
        >
            ...
            <View style={{
                ...
                <View style={{ left: 10, marginBottom: 20 }} >
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', top: 6 }}>
                        ...
                        <Text style={{ fontSize: 16, color: "#ffbc2d" }}>Rs.600</Text>
            ...
            <View style={{
                ...
                <View style={styles.box}>
                    ...
                    <Text style={styles.boxtxt}>12 oct 2022</Text>
                </View>
                <View style={styles.box} >
                    <Text style={styles.text}>Booking Time
                    </Text>
                    <Text style={styles.boxtxt}>9:00 AM</Text>
                </View>
            </View>
